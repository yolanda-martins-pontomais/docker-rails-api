...
SimpleCov.start do
  ...
  add_filter "spec/"
  add_filter "app/models/concerns/visible.rb"
  ...
  add_filter "config/initializers/application_controller_renderer.rb"
  add_filter "config/initializers/backtrace_silencers.rb"
  add_filter "config/initializers/cors.rb"
  add_filter "config/initializers/filter_parameter_logging.rb"
